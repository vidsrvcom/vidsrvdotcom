...
try {
    switch ($action) {
        ...
        case 'similar':
            ...
            $result = getSimilarVideos($pdo, $id);
            break;
    ...
    echo json_encode([
        ...
        ...(isset($result['reference_video']) ? ['reference_video' => $result['reference_video']] : []),
